...
CREATE TABLE `delivery` (
  ...
  KEY `delivery_address_user` (`address`),
  CONSTRAINT `delivery_address_user` FOREIGN KEY (`address`) REFERENCES `users` (`address`),
  CONSTRAINT `delivery_order_id_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
...
CREATE TABLE `order_detail` (
  ...
  KEY `fk_order_detail_to_orders` (`order_id`),
...
INSERT INTO `products` VALUES (1,'Pepe Jeans',120,'Female',97),(2,'The Run',110,'Female',98),(3,'Style Vesture',150,'Female',99),(4,'Sweet Rose',165,'Female',100),(5,'Frock Works',135,'Female',100),(6,'Honey Punch',155,'Female',100),(7,'Nighty Nine',170,'Female',100),(8,'The Goodly',155,'Female',100),(9,'Fine Touch',145,'Female',100),(10,'Simply Seattle',180,'Female',100),(11,'Seemly Garb',125,'Female',100),(12,'Style Wear',170,'Female',100);
...
-- Dump completed on 2023-07-04 15:01:11
